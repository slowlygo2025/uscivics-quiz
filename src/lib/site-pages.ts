  ...
  },
  {
    ...
    sections: {
      en: [
        ...
        {
          heading: "Sharing",
          body: "We share data with service providers who help us run the site (hosting such as Vercel, analytics, advertising, and error monitoring such as Sentry). We do not sell your email as a standalone product. We may disclose information if required by law or to protect rights, safety, and security.",
        },
        {
          heading: "Children",
      ...
      zh: [
        {
          heading: "概述",
          body: "USCivics Quiz（“我们”）运营 https://uscivics-quiz.com。本政策说明您使用本网站时我们会处理哪些信息。最后更新日期：2026 年 8 月 2 日。",
        },
        {
          heading: "您提供的信息",
          body: "您无需创建账户即可使用本网站。如果您给我们发邮件，我们会收到您发送的邮箱地址和邮件内容。诸如用于查询民选官员的邮政编码（ZIP）等可选输入信息，仅用于返回学习结果，不会用于构建营销画像。",
        },
        {
          heading: "存储在您设备上的信息",
        ...
        {
          heading: "广告",
          body: "如果您在我们的 Cookie 横幅中选择“全部接受”，我们可能会展示第三方广告（包括 Monetag／相关广告网络）。广告合作伙伴可能会使用 Cookie、像素或类似技术来投放和衡量广告。他们的做法受各自政策约束。选择“仅必要”可让学习工具继续正常运行，而不会加载我们的广告脚本。",
        },
        {
        ...
        {
          heading: "您的选择与请求",
          body: `您可以清除浏览器中的本地网站数据、屏蔽 Cookie，或就隐私相关问题发邮件至 ${CONTACT_EMAIL}。由于我们不要求注册账户，除了您通过邮件发送给我们的信息，或服务提供商在日志/分析中存储的信息外，我们掌握的个人数据可能非常有限。`,
        },
        {
          heading: "变更",
      ...
      vi: [
        {
          heading: "Tổng quan",
          body: "USCivics Quiz (“chúng tôi”) vận hành https://uscivics-quiz.com. Chính sách này giải thích những thông tin chúng tôi xử lý khi bạn sử dụng trang web. Cập nhật lần cuối: ngày 2 tháng 8 năm 2026.",
        },
        {
          heading: "Thông tin bạn cung cấp",
          body: "Bạn có thể sử dụng trang web mà không cần tạo tài khoản. Nếu bạn gửi email cho chúng tôi, chúng tôi sẽ nhận được địa chỉ và nội dung tin nhắn bạn gửi. Các thông tin tùy chọn như mã ZIP dùng để tra cứu quan chức được xử lý để trả về kết quả học tập và không được dùng để xây dựng hồ sơ tiếp thị.",
        },
        {
        ...
        {
          heading: "Quảng cáo",
          body: "Nếu bạn chọn Chấp nhận tất cả trên biểu ngữ cookie của chúng tôi, chúng tôi có thể hiển thị quảng cáo của bên thứ ba (bao gồm Monetag / các mạng quảng cáo liên quan). Các đối tác quảng cáo có thể dùng cookie, pixel, hoặc công nghệ tương tự để phân phối và đo lường quảng cáo. Hoạt động của họ tuân theo chính sách riêng của họ. Chọn Chỉ thiết yếu giúp công cụ học tập vẫn hoạt động mà không tải các script quảng cáo của chúng tôi.",
        },
        {
      ...
      tl: [
        ...
        {
          heading: "Advertising",
          body: "Kung pipiliin mo ang Tanggapin lahat sa aming cookie banner, maaari kaming magpakita ng mga ad ng third-party (kabilang ang Monetag / kaugnay na ad network). Maaaring gumamit ang mga ad partner ng cookies, pixels, o katulad na teknolohiya para maghatid at sukatin ang mga ad. Ang kanilang mga gawi ay pinamamahalaan ng sariling patakaran nila. Kung pipiliin ang Mahahalaga lamang, patuloy na gagana ang mga study tool nang hindi nilo-load ang aming advertising scripts.",
        },
        {
        ...
        },
        {
          ...
          body: `Maaari mong i-clear ang lokal na data ng site sa iyong browser, harangan ang cookies, o mag-email sa ${CONTACT_EMAIL} para sa mga tanong tungkol sa privacy. Dahil hindi kami humihingi ng account, maaaring limitado ang aming personal na data maliban sa ipinadala mo sa amin sa email o iniimbak ng mga provider sa logs/analytics.`,
        },
        {
      ...
      ar: [
        {
          heading: "نظرة عامة",
          body: "تدير USCivics Quiz (“نحن”) الموقع https://uscivics-quiz.com. توضح هذه السياسة المعلومات التي نعالجها عند استخدامك للموقع. آخر تحديث: 2 أغسطس 2026.",
        },
        {
          heading: "المعلومات التي تقدمها",
          body: "يمكنك استخدام الموقع دون إنشاء حساب. إذا راسلتنا عبر البريد الإلكتروني، فسنستلم عنوانك ومحتوى الرسالة التي ترسلها. تتم معالجة المدخلات الاختيارية مثل الرمز البريدي المستخدم للبحث عن المسؤولين المنتخبين لإرجاع نتائج الدراسة فقط، ولا تُستخدم لإنشاء ملف تسويقي.",
        },
        {
        ...
        {
          heading: "الإعلانات",
          body: "إذا اخترت “قبول الكل” في شريط ملفات تعريف الارتباط لدينا، فقد نعرض إعلانات من جهات خارجية (بما في ذلك Monetag / شبكات الإعلانات ذات الصلة). قد يستخدم شركاء الإعلانات ملفات تعريف الارتباط أو وحدات البكسل أو تقنيات مماثلة لعرض الإعلانات وقياسها. تخضع ممارساتهم لسياساتهم الخاصة. اختيار “الأساسيات فقط” يبقي أدوات الدراسة تعمل دون تحميل نصوص الإعلانات لدينا.",
        },
        {
        ...
        },
        {
          ...
          body: `يمكنك مسح بيانات الموقع المحلية في متصفحك، أو حظر ملفات تعريف الارتباط، أو مراسلتنا عبر ${CONTACT_EMAIL} للأسئلة المتعلقة بالخصوصية. نظراً لأننا لا نطلب حسابات، فقد تكون لدينا بيانات شخصية محدودة بخلاف ما ترسله إلينا عبر البريد الإلكتروني أو ما يخزنه مزودو الخدمة في السجلات/التحليلات.`,
        },
        {
          heading: "التغييرات",
      ...
      ko: [
        {
          heading: "개요",
          body: "USCivics Quiz(“저희”)는 https://uscivics-quiz.com을 운영합니다. 이 정책은 귀하가 사이트를 이용할 때 저희가 처리하는 정보에 대해 설명합니다. 최종 업데이트: 2026년 8월 2일.",
        },
        {
          heading: "귀하가 제공하는 정보",
          body: "계정을 만들지 않고도 사이트를 이용할 수 있습니다. 이메일을 보내주시면 발신 주소와 메시지 내용을 수신하게 됩니다. 선출직 공무원 조회에 사용되는 우편번호와 같은 선택적 입력 정보는 학습 결과를 제공하기 위해 처리되며 마케팅 프로필 작성에는 사용되지 않습니다.",
        },
        {
        ...
        {
          heading: "광고",
          body: "쿠키 배너에서 ‘전체 동의’를 선택하시면 저희는 제3자 광고(Monetag / 관련 광고 네트워크 포함)를 표시할 수 있습니다. 광고 파트너는 쿠키, 픽셀 또는 유사 기술을 사용하여 광고를 게재하고 측정할 수 있습니다. 이들의 관행은 자체 정책에 따라 규율됩니다. ‘필수만 허용’을 선택하면 광고 스크립트를 로드하지 않고도 학습 도구가 계속 작동합니다.",
        },
        {
          heading: "쿠키 및 유사 기술",
        ...
        {
          heading: "귀하의 선택 및 요청",
          body: `귀하는 브라우저에서 로컬 사이트 데이터를 지우거나, 쿠키를 차단하거나, 개인정보 관련 문의를 위해 ${CONTACT_EMAIL}로 이메일을 보낼 수 있습니다. 저희는 계정을 요구하지 않으므로, 귀하가 이메일로 보낸 정보나 제공업체가 로그/분석에 저장하는 정보 외에는 보유하는 개인정보가 제한적일 수 있습니다.`,
        },
        {
          heading: "변경사항",
      ...
      hi: [
        {
          heading: "अवलोकन",
          body: "USCivics Quiz (“हम”) https://uscivics-quiz.com का संचालन करता है। यह नीति बताती है कि जब आप साइट का उपयोग करते हैं तो हम कौन सी जानकारी संसाधित करते हैं। अंतिम अपडेट: 2 अगस्त, 2026।",
        },
        {
          heading: "आपके द्वारा दी गई जानकारी",
          body: "आप बिना खाता बनाए साइट का उपयोग कर सकते हैं। यदि आप हमें ईमेल करते हैं, तो हमें आपका भेजा गया पता और संदेश की सामग्री प्राप्त होती है। निर्वाचित अधिकारियों की खोज के लिए उपयोग किए जाने वाले ZIP कोड जैसे वैकल्पिक इनपुट को अध्ययन परिणाम लौटाने के लिए संसाधित किया जाता है और इनका उपयोग मार्केटिंग प्रोफ़ाइल बनाने के लिए नहीं किया जाता।",
        },
        {
        ...
        {
          heading: "विज्ञापन",
          body: "यदि आप हमारे कुकी बैनर पर सभी स्वीकार करें चुनते हैं, तो हम तृतीय-पक्ष विज्ञापन (Monetag / संबंधित विज्ञापन नेटवर्क सहित) दिखा सकते हैं। विज्ञापन भागीदार विज्ञापन देने और मापने के लिए कुकीज़, पिक्सेल, या समान तकनीकों का उपयोग कर सकते हैं। उनकी प्रथाएं उनकी अपनी नीतियों द्वारा शासित होती हैं। केवल आवश्यक चुनने से हमारे विज्ञापन स्क्रिप्ट लोड किए बिना अध्ययन उपकरण काम करते रहते हैं।",
        },
        {
        ...
        },
        {
          ...
          body: `आप अपने ब्राउज़र में स्थानीय साइट डेटा साफ़ कर सकते हैं, कुकीज़ को ब्लॉक कर सकते हैं, या गोपनीयता संबंधी प्रश्नों के लिए ${CONTACT_EMAIL} पर ईमेल कर सकते हैं। चूंकि हमें खातों की आवश्यकता नहीं है, इसलिए आपके द्वारा हमें ईमेल की गई जानकारी या प्रदाताओं द्वारा लॉग/एनालिटिक्स में संग्रहीत जानकारी से परे हमारे पास सीमित व्यक्तिगत डेटा हो सकता है।`,
        },
        {
          heading: "परिवर्तन",
      ...
      ru: [
        {
          heading: "Обзор",
          body: "USCivics Quiz («мы») управляет сайтом https://uscivics-quiz.com. Эта политика объясняет, какую информацию мы обрабатываем при использовании вами сайта. Последнее обновление: 2 августа 2026 г.",
        },
        {
        ...
        {
          heading: "Реклама",
          body: "Если вы выберете «Принять все» в баннере о файлах cookie, мы можем показывать рекламу третьих сторон (включая Monetag / связанные рекламные сети). Рекламные партнёры могут использовать файлы cookie, пиксели или аналогичные технологии для показа и измерения рекламы. Их практика регулируется их собственными политиками. Выбор «Только необходимое» позволяет учебным инструментам работать без загрузки наших рекламных скриптов.",
        },
        {
      ...
      ht: [
        {
          ...
          body: "USCivics Quiz (“nou”) opere https://uscivics-quiz.com. Règleman sa a eksplike ki enfòmasyon nou trete lè w itilize sit la. Dènye mizajou: 2 out 2026.",
        },
        {
          heading: "Enfòmasyon ou bay",
          body: "Ou ka itilize sit la san w pa kreye yon kont. Si w voye yon imel ba nou, nou resevwa adrès ak kontni mesaj ou voye a. Enfòmasyon opsyonèl tankou yon kòd postal (ZIP) ki itilize pou chèche ofisyèl eli yo trete pou retounen rezilta etid; nou pa itilize yo pou konstwi yon pwofil maketing.",
        },
        {
        ...
        {
          heading: "Piblisite",
          body: "Si w chwazi Aksepte tout sou bannyè cookie nou an, nou ka montre piblisite twazyèm pati (ki gen ladan Monetag / rezo piblisite ki gen rapò). Patnè piblisite yo ka itilize cookies, pixel, oswa teknoloji similè pou livre ak mezire piblisite. Pratik yo gouvène pa pwòp règleman pa yo. Chwazi Sèlman esansyèl kenbe zouti etid yo ap travay san yo pa chaje script piblisite nou yo.",
        },
        {
        ...
        },
        {
          ...
          body: `Ou ka efase done lokal sit la nan navigatè ou, bloke cookies, oswa voye yon imel bay ${CONTACT_EMAIL} pou kesyon sou vi prive. Piske nou pa egzije kont, nou ka gen done pèsonèl limite apa de sa w voye ba nou pa imel oswa sa founisè yo estoke nan jounal/analiz.`,
        },
        {
          heading: "Chanjman",
      ...
      fr: [
        {
          heading: "Aperçu",
          body: "USCivics Quiz (« nous ») exploite https://uscivics-quiz.com. Cette politique explique quelles informations nous traitons lorsque vous utilisez le site. Dernière mise à jour : 2 août 2026.",
        },
        {
        ...
        {
          heading: "Publicité",
          body: "Si vous choisissez Tout accepter sur notre bannière de cookies, nous pouvons afficher des publicités tierces (y compris Monetag / réseaux publicitaires associés). Les partenaires publicitaires peuvent utiliser des cookies, des pixels ou des technologies similaires pour diffuser et mesurer les publicités. Leurs pratiques sont régies par leurs propres politiques. Choisir Essentiels uniquement permet aux outils d'étude de continuer à fonctionner sans charger nos scripts publicitaires.",
        },
        {
  ...
  },
  {
    ...
    sections: {
      ...
      zh: [
        {
          heading: "协议",
          body: "使用 https://uscivics-quiz.com（“本网站”）即表示您同意本服务条款。如果您不同意，请勿使用本网站。最后更新日期：2026 年 8 月 2 日。",
        },
        {
          heading: "本网站是什么",
      ...
      vi: [
        {
          heading: "Thỏa thuận",
          body: "Bằng việc sử dụng https://uscivics-quiz.com (“Trang web”), bạn đồng ý với các Điều khoản Dịch vụ này. Nếu bạn không đồng ý, vui lòng không sử dụng Trang web. Cập nhật lần cuối: ngày 2 tháng 8 năm 2026.",
        },
        {
      ...
      tl: [
        {
          heading: "Kasunduan",
          body: "Sa paggamit ng https://uscivics-quiz.com (ang “Site”), sumasang-ayon ka sa mga Tuntunin ng Serbisyong ito. Kung hindi ka sumasang-ayon, huwag gamitin ang Site. Huling na-update: Agosto 2, 2026.",
        },
        {
      ...
      ar: [
        {
          heading: "الموافقة",
          body: "باستخدامك لموقع https://uscivics-quiz.com (“الموقع”)، فإنك توافق على شروط الخدمة هذه. إذا كنت لا توافق، فلا تستخدم الموقع. آخر تحديث: 2 أغسطس 2026.",
        },
        {
      ...
      ko: [
        {
          heading: "동의",
          body: "https://uscivics-quiz.com(“사이트”)를 이용함으로써 귀하는 본 서비스 약관에 동의하는 것입니다. 동의하지 않으시면 사이트를 이용하지 마십시오. 최종 업데이트: 2026년 8월 2일.",
        },
        {
          heading: "사이트란",
      ...
      hi: [
        {
          heading: "समझौता",
          body: "https://uscivics-quiz.com (“साइट”) का उपयोग करके, आप इन सेवा शर्तों से सहमत होते हैं। यदि आप सहमत नहीं हैं, तो साइट का उपयोग न करें। अंतिम अपडेट: 2 अगस्त, 2026।",
        },
        {
      ...
      ru: [
        {
          heading: "Соглашение",
          body: "Используя https://uscivics-quiz.com («Сайт»), вы соглашаетесь с настоящими Условиями использования. Если вы не согласны, не используйте Сайт. Последнее обновление: 2 августа 2026 г.",
        },
        {
      ...
      ht: [
        {
          heading: "Akò",
          body: "Lè w itilize https://uscivics-quiz.com (“Sit la”), ou dakò ak Kondisyon Sèvis sa yo. Si w pa dakò, pa itilize Sit la. Dènye mizajou: 2 out 2026.",
        },
        {
      ...
      fr: [
        {
          heading: "Accord",
          body: "En utilisant https://uscivics-quiz.com (le « Site »), vous acceptez les présentes Conditions d'utilisation. Si vous n'êtes pas d'accord, n'utilisez pas le Site. Dernière mise à jour : 2 août 2026.",
        },
        {
